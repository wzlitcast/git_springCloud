package com.aspire.commons.csv.support.convert.write;

import com.aspire.commons.csv.api.IWriteConverter;
import com.aspire.commons.csv.support.context.SingleWriteContext;
import com.aspire.commons.csv.support.convert.write.collection.ArrayWriteConverter;
import com.aspire.commons.csv.support.convert.write.collection.CollectionWriteConverter;
import com.aspire.commons.csv.support.convert.write.collection.MapWriteConverter;
 ...
 * （2）其他类直接使用 {@link StringUtil#objectToString(Object, String)} 转为字符串
 * @author binbin.hou
 * @since 0.0.3

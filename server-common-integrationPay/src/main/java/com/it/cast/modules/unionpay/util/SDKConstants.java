 ...
 * =============================================================================
 */
package com.it.cast.modules.unionpay.util;
...
public class SDKConstants {
	...
	/** memeber variable: controller ne. */
	public static final String NE = "!=";

	/** memeber variable: controller le. */
	public static final String LE = "<=";

	/** memeber variable: controller ge. */
	public static final String GE = ">=";

	/** memeber variable: controller lt. */
	public static final String LT = "<";

	/** memeber variable: controller gt. */
